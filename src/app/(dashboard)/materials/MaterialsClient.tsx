...
function materialSourceLabel(material: MaterialData) {
  if (material.source === "CUSTOM") return "自訂";
  if (material.source === "OVERRIDE") return "已改價";
  return "系統";
}
              ...
              {visibleMaterials.map((material) => (
                ...
                >
                  ...
                  <td className="px-4 py-2">
                    ...
                    <div className="mt-0.5 text-[10px] text-muted-foreground">{materialSourceLabel(material)}</div>
                    {material.colorCode && material.name !== material.colorCode && (
